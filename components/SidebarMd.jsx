...
const SidebarMd = ({atab=0}) => {
  return (
    <div className="min-[768px]:hidden w-screen grid-cols-4 gap-0.5 p-2 py-0.5 h-fit bg-[var(--foreground)] grid rounded-md shadow-md border-t-2 border-[var(--border-color)] sticky bottom-0">
        {options.map((i,index)=>(
